...
- `domain` - containing code base regarding the business logic and models
- `infra` - containing specific code for infrastructure pieces of the application to keep them isolated
